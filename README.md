...
TleApi - JavaScript client for tle_api
...
To use the link you just defined in your project, switch to the directory you want to use your tle_api from, and run:
